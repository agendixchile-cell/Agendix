...
export function RegisterForm({ selectedPlanId }: RegisterFormProps) {
      ...
      <div className="rounded-2xl border border-[#ebe7df] bg-white/85 p-6 shadow-xl shadow-slate-900/[0.06] sm:p-7">
        ...
        <div className="mb-5 rounded-xl border border-orange-200/70 bg-orange-50 px-4 py-3">
          <p className="text-sm font-semibold text-orange-900">
            Plan seleccionado: {selectedPlan.shortName}
          </p>
          <p className="mt-1 text-sm leading-6 text-orange-800/80">
            {selectedPlan.positioning}{' '}
            {selectedPlan.ctaKind === 'sales'
              ? 'Nuestro equipo revisará el alcance contigo antes de activar funciones Enterprise.'
